...
def save_and_fit(fit):
    with app.app_context():
        ...
        s3.upload_file(Filename='tmp_file.cb_model', Bucket='just-a-name', Key='models/' + str(fit.id))
...
def show_fit(id):
    ...
    if superform.validate_on_submit():
        ...
        s3.download_file(Bucket='just-a-name', Key='models/' + str(id), Filename='tmp_file.cb_model')
